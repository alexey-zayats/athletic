#ifndef BEGIN_REQUEST_RECORD_H
#define BEGIN_REQUEST_RECORD_H
...
DECLARE_DEBUG_ENUM(FastCgi::BeginRequestRecord, Role)
Q_DECLARE_OPERATORS_FOR_FLAGS(FastCgi::BeginRequestRecord::Flags)

#endif // BEGIN_REQUEST_RECORD_H
