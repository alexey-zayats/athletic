...
bool panelWidget(const QWidget *widget)
{
    ...
    if (qobject_cast<const MainWindow *>(widget))
        return true;
                                   ...
                                   QPainter *painter, const QWidget *widget) const
{
    ...
    case PE_PanelButtonTool: {
            ...
            if (!animating && anim) {
                ...
                if (pressed) {
                    const QColor shade = creatorTheme()->color(Theme::ToolButtonSelectedColor);
    ...
    case CE_MenuBarItem:
        ...
        if (const QStyleOptionMenuItem *mbi = qstyleoption_cast<const QStyleOptionMenuItem *>(option)) {
            ...
            if (act) {
                // Fill|
                if (creatorTheme()->flag(Theme::FlatMenuBar)) {
                    painter->fillRect(option->rect, creatorTheme()->color(Theme::ToolButtonHoverColor));
                } else {
            ...
            if (creatorTheme()->flag(Theme::DrawToolBarHighlights)) {
                ...
                if (horizontal) {
                    ...
                    const QColor hightLight = creatorTheme()->widgetStyle() == Theme::StyleDefault
                            ...
                            : creatorTheme()->color(Theme::ToolBarSeparatorColor);
