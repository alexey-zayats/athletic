...
struct ModeManagerPrivate
{
    ...
    Internal::TabWidget *m_modeStack;
    Internal::ActionBar *m_actionBar;
                         ...
                         Internal::TabWidget *modeStack)
{
    ...
    d->m_oldCurrent = -1;
    d->m_actionBar = new Internal::ActionBar(modeStack);
    d->m_modeStack->addCornerWidget(d->m_actionBar);
    d->m_modeSelectorVisible = true;
    d->m_modeStack->setSelectionWidgetVisible(d->m_modeSelectorVisible);

    connect(d->m_modeStack, &Internal::TabWidget::currentAboutToShow,
            this, &ModeManager::currentTabAboutToChange);
    connect(d->m_modeStack, &Internal::TabWidget::currentChanged,
