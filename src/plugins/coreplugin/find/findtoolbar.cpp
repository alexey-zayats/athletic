      ...
      m_findStepTimer(this)
{
    ...
    connect(m_ui.findEdit, &Utils::LineEdit::editingFinished,
    ...
    connect(m_ui.findEdit, &Utils::LineEdit::textChanged,
            this, &FindToolBar::invokeFindIncremental);
    connect(m_ui.findEdit, &Utils::LineEdit::leftButtonClicked,
    ...
    connect(m_ui.findEdit, &Utils::LineEdit::returnPressed,
            this, &FindToolBar::invokeFindEnter, Qt::QueuedConnection);
    connect(m_ui.replaceEdit, &Utils::LineEdit::returnPressed,
...
{
    disconnect(m_ui.findEdit, &Utils::LineEdit::textChanged,
               this, &FindToolBar::invokeFindIncremental);
...
void FindToolBar::updateIcons()
{
    ...
    if (!casesensitive && !wholewords && !regexp && !preserveCase) {
        ...
        m_ui.findEdit->setButtonPixmap(Utils::LineEdit::Left, pixmap);
    } else {
        m_ui.findEdit->setButtonPixmap(Utils::LineEdit::Left,
...
{
    QAbstractButton *optionsButton = m_ui.findEdit->button(Utils::LineEdit::Left);
    // close tab order
