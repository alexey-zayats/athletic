...
void ToolButton::paintEvent(QPaintEvent *event)
{
    ...
    if (!HostOsInfo::isMacHost() // Mac UIs usually don't hover
        ...
        if (creatorTheme()->widgetStyle() == Theme::StyleDefault) {
            ...
            const QColor hoverColor = creatorTheme()->color(Theme::ToolButtonHoverColor);
        ...
        painter.save();
        const QColor selectedColor = creatorTheme()->color(Theme::ToolButtonSelectedColor);
        if (creatorTheme()->widgetStyle() == Theme::StyleDefault) {
...
void ActionBar::paintEvent(QPaintEvent *event)
{
    ...
    if (creatorTheme()->widgetStyle () == Theme::StyleFlat) {
        ...
        painter.setPen(creatorTheme()->color(Theme::ToolBarSeparatorColor));
...
void ToolButton::hoverOverlay(QPainter *painter, const QRect &spanRect)
{
...
{
    m_actionsLayout->insertWidget(0, new ToolButton(action, this));

}
void ActionBar::insertAction(int index, QAction *action)
{
    m_actionsLayout->insertWidget(index, new ToolButton(action, this));
}

QLayout *ActionBar::actionsLayout() const
{
