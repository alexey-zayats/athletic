...
APP_VERSION_TAG = $$replace(APP_VERSION, "[-.]", )
...
defineReplace(qdoc) {
	return("$$cmdEnv(SRCDIR=$$PWD OUTDIR=$$1 APP_VERSION=$$APP_VERSION APP_VERSION_TAG=$$APP_VERSION_TAG $$QDOC_GLOBAL) $$QDOC_BIN")
}

QHP_FILE = $$OUT_PWD/doc/html/athletic.qhp
QCH_FILE = $$APP_DOC_PATH/athletic.qch

HELP_DEP_FILES = $$PWD/src/athletic.qdoc \
